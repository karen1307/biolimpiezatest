...
function asignarProfesional(){
    ...
    window.alert("No fue posible cambiar la fecha de prestación de servicio. Ha faltado a la política que establece el período máximo de reprogramación de 24 horas")
}